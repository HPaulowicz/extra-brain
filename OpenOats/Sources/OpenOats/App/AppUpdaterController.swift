...
final class AppUpdaterController {
    ...
    private func presentStartupError() {
        ...
        alert.informativeText = "The updater failed to start. Please verify you have the latest version of Extra Brain and contact the developer if the issue persists."
        alert.runModal()
    }

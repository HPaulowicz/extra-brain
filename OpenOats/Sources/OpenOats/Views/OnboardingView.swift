...
struct OnboardingView: View {
    ...
    private let steps: [(icon: String, title: String, body: String)] = [
        ...
        (
            "lightbulb",
            "AI Suggestions",
            "As the conversation progresses, Extra Brain pulls relevant context from your knowledge base and suggests talking points. The best suggestions surface automatically."
        ),
        (

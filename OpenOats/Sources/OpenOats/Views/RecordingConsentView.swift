...
struct RecordingConsentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("""
            Extra Brain records and transcribes audio from your microphone \
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                consentBullet("The developers of Extra Brain accept no liability for unauthorized or unlawful recording.")
            }

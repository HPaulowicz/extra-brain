...
cd "$(dirname "$0")/.."
APP_PATH="dist/Extra Brain.app"
DMG_PATH="dist/Extra Brain.dmg"
...
TEMP_DMG="dist/Extra Brain_temp.dmg"
...
hdiutil create -volname "Extra Brain" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "Extra Brain"
    ...
    set position of item "Extra Brain.app" of container window to {120, 150}
